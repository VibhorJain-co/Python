...
def TrainNoEntry():
    while True:
        try:
            train_no = int(input("TrainNo (Enter a 3-4 digit number): "))
            break
        except ValueError:
            print("\nPlease enter a number ")

    if train_no > 9999 or train_no < 100:
            print("\nPlease enter a 3-4 digit train no ")
            train_no = TrainNoEntry()
